 ...
 */
fun funcionTipica(a: Int, b: Int): Int {
    return a/b
}
    //  println(funcionTipica(100, 2))


// Funcion escrita abreviada en una sola linea
fun funcionAbreviadaLinea(a: Int, b: Int): Int = a/b
    // fun main() = println(funcionAbreviadaLinea(100, 2))

// definir la funcion con valores estandar por si falta alguno por meter
fun funcionAbreviadaValoresEstandar(a: Int = 10, b: Int = 5): Int = a/b
    //fun main() = println(funcionAbreviadaValoresEstandar())
